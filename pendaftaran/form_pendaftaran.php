...
<div class="form-container">
    <div class="form-header">
        ...
        <p>Silakan isi data calon siswa dengan lengkap dan benar.</p>
    </div>
    ...
    <form action="proses_pendaftaran.php" method="POST" novalidate>
        ...
        <div class="d-flex justify-content-between mt-4">
            <button type="reset" class="btn btn-outline-secondary"><i class="fas fa-sync-alt"></i> Reset</button>
            <button type="submit" class="btn btn-gradient"><i class="fas fa-paper-plane"></i> Daftar Sekarang</button>
        </div>
    </form>
