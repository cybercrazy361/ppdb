...
<?php endif; ?>
    ...
    <table class="data-table">
      ...
      <div class="status-print-row" style="
        display: flex;
        ...
        padding: 10px 18px;
        border-radius: 9px;
        background: linear-gradient(90deg,#eef6fa 60%,#ecfcff 100%);
        box-shadow: 0 2px 12px 0 rgba(78,145,223,0.07);
        font-size: 15px;
      ">
        <div style="font-weight: bold;">
          Status Pendaftaran: <span style="font-weight:normal;color:#174edc">PPDB Bersama</span>
        </div>
        <div style="font-weight: bold;">
          Keterangan: <span style="font-weight:normal;color:#222">-</span>
        </div>
      </div>
