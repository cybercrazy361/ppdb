...
// 2. Total Pendaftaran
$sql_total_pendaftaran = "SELECT COUNT(*) AS total_pendaftaran FROM calon_pendaftar";
...
$total_pendaftaran = $result_total_pendaftaran->fetch_assoc()['total_pendaftaran'];
$stmt_total_pendaftaran->close();

// 3. Laporan Bulanan
$sql_laporan_bulanan = "SELECT COUNT(*) AS laporan_bulanan FROM pembayaran WHERE MONTH(tanggal_pembayaran) = MONTH(CURRENT_DATE())";
