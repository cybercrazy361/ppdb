...
// Ambil data dari tabel keuangan dengan LIMIT dan OFFSET
$sql = "SELECT * FROM keuangan ORDER BY id ASC LIMIT $data_per_halaman OFFSET $offset";
$result = $conn->query($sql);

// Hitung total data
$total_data_sql = "SELECT COUNT(*) AS total FROM keuangan";
...
if ($result->num_rows > 0) {
    ...
    echo "<tr><td colspan='5' class='text-center'>Tidak ada data petugas keuangan.</td></tr>";
}
?>
