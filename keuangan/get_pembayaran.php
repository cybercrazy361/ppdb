...
// Ambil data header pembayaran
$stmt_pembayaran = $conn->prepare("
    SELECT p.id, p.no_formulir, s.nama, p.jumlah, p.metode_pembayaran, p.tahun_pelajaran, p.keterangan
    FROM pembayaran p
...
$stmt_detail = $conn->prepare("
    SELECT jenis_pembayaran_id, jumlah, bulan, status_pembayaran, cashback
